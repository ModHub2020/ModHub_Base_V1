...
void MYTD()
{
	...
	int textureID;
	if (FE(FP))
		file_register(&textureID, FP.c_str(), true, n.c_str(), false);
}
	...
	if (IconSwitch)
	{
		...
		if (b00l)
		{
			...
			if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
				...
				Drawing::Spriter("commonmenu", "shop_box_blankb", Settings::menuX + 0.077f, ((Settings::optionCount - (Settings::currentOption - 14)) * 0.04f + 0.14f), 0.016f, 0.028f, 0, 57, 25, 23, 255); //4, 101, 247
		}
		else
		{
			if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
				...
				Drawing::Spriter("commonmenu", "shop_box_crossb", Settings::menuX + 0.077f, ((Settings::optionCount - (Settings::currentOption - 14)) * 0.04f + 0.14f), 0.03f, 0.054f, 0, 255, 0, 0, 255);
